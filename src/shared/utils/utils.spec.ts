...
describe('shared/utils/utils.ts', () => {
  ...
  it('formatDateYYYYMMDD (UTC+0)', () => {
    ...
    const validDates: Record<string, Date> = {
      ...
      '2023-06-30': Utils.createUtcDate(new Date('2023-06-30T02:59:00Z')),
      '2023-07-01': Utils.createUtcDate(new Date('2023-07-01T02:59:00Z')),
      '2023-07-02': Utils.createUtcDate(new Date('2023-07-02T03:00:01Z')),
      '2023-07-04': Utils.createUtcDate(new Date('2023-07-04T02:59:00Z')),
  ...
  it('formatDateYYYYMMDD (America/Sao_Paulo)', () => {
    ...
    const validDates: Record<string, Date> = {
      ...
      '2023-06-29': Utils.createBrlDate(new Date('2023-06-30T02:59:00Z')),
      '2023-06-30': Utils.createBrlDate(new Date('2023-07-01T02:59:00Z')),
      '2023-07-02': Utils.createBrlDate(new Date('2023-07-02T03:00:01Z')),
      '2023-07-03': Utils.createBrlDate(new Date('2023-07-04T02:59:00Z')),
